...
import { Image, View, ScrollView, StatusBar, TouchableOpacity, TextInput, StyleSheet} from "react-native";
        ...
        <View style={styles.ListScreen}>					
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                <View style={[styles.listBody,{paddingTop:20}]}>
                    <Text style={styles.homePropertyName}>Report this Listing</Text>
                    <Text style={[styles.hrBoxHeading,{fontSize:14,paddingTop:10}]}>WHAT IS WRONG WITH THIS LISTING?</Text>
                    ...
                    <TouchableOpacity><Text style={styles.customBtn} uppercase={true}> save </Text></TouchableOpacity>
                </View>
            </ScrollView>
        </View>
        );
